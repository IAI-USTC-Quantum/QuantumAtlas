...
| 症状 | 检查 | 处理 |
|---|---|---|
| `rawstore: error: bucket does not exist` | bucket 名错或 RustFS 重启丢了 bucket | 跑 [`scripts/rustfs_bootstrap.sh`](rustfs.md#bootstrap-initial-rustfs-setup) 重建 |
