    ...
    "paths": {
        ...
        "/api/admin/whoami": {
            "get": {
                ...
                "description": "Returns {login, is_admin, is_user_admin, is_superadmin}\nfor the signed-in session user. is_admin is the env\nallowlist gate (ops dashboard); is_user_admin /\nis_superadmin mirror the /api/admin/users guard for the\nuser-management nav. The SPA uses these to decide which\nadmin surfaces to render; non-admins get false flags\nrather than a 403. Session-token auth only (PAT auth\nrefused, same as /api/pat).",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/me": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{id, email, name, avatar, github_login, is_admin, is_superadmin, created}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
