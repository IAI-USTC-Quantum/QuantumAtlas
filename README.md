...
- [x] 预留各模块接口（extractor/designer/codegen/validator/estimator）
- [ ] 实现 Circuit Designer + Qiskit Code Generator
- [ ] 集成 Validator + Resource Estimator
...
| `atlas/extractor/` | LLM 信息提取 | 🚧 接口预留 |
| `atlas/designer/` | 电路设计器 | 🚧 待实现 |
| `atlas/codegen/` | 代码生成器 | 🚧 待实现 |
| `atlas/validator/` | 电路验证器 | 🚧 待实现 |
| `atlas/estimator/` | 资源估计器 | 🚧 待实现 |
