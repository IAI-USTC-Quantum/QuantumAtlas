...
class WikiEngine:
    ...
    def __init__(
        ...
        Args:
            ...
            raw_dir: Path to raw directory (default: ./raw)
        ...
        self.wiki_dir = self.project_root / (wiki_dir or "wiki")
        self.raw_dir = self.project_root / (raw_dir or "raw")
    ...
    def _ensure_directories(self) -> None:
        """Create wiki and raw directory structure if not exists."""
        # Wiki subdirectories
        wiki_subdirs = [
            "concepts",
            "entities/algorithms",
